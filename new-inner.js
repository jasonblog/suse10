//document.domain = "http://hiad.myweb.hinet.net/myweb.hinet.net";
...
function activeReload(){	  	   	   	       
	    Reload_AD_Page = "http://hiad.myweb.hinet.net/120_600.html";	    
...
if ( location.host != 'http://hiad.myweb.hinet.net/cmhsieh1.myweb.hinet.net' ) {

if (top == self){
	        MainPageURL = para_type();		        	        	        
          AdPageURL = "http://hiad.myweb.hinet.net/120_600.html";
          AD_width = 120;
          scroll_type = "no";
